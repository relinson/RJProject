...
namespace PRO_ReceiptsInvMgr.UpdateApp
{
    ...
    public static class ZipHelper
    {
        ...
        private static bool ZipDirectory(string folderToZip, ZipOutputStream zipStream, string parentFolderName)
        {
            ...
            {
                string backSlash = "/";
                ent = new ZipEntry(Path.Combine(parentFolderName, Path.GetFileName(folderToZip) + backSlash));
                ...
                foreach (string file in files)
                {
                    ...
                    ent = new ZipEntry(Path.Combine(parentFolderName, Path.GetFileName(folderToZip) + backSlash + Path.GetFileName(file)));
