...
namespace Util.Controls
{
    ...
    public static class NativeMethods
    {
        ...
        extern private static  void SetWindowLong(IntPtr handle, int oldStyle, int newStyle);

        public static void InvokeSetWindowLong(IntPtr handle, int oldStyle, int newStyle)
        {
            SetWindowLong(handle, oldStyle, newStyle);
        }
        ...
        [System.Runtime.InteropServices.DllImport("User32.dll")]
        private static extern int GetWindowLong(IntPtr handle, int style);

        public static int InvokeGetWindowLong(IntPtr handle, int style)
        {
            return GetWindowLong(handle,style);
        }
        ...
        /// <returns>返回值</returns>
        [System.Runtime.InteropServices.DllImport("User32.dll")]
        private static extern int SetWindowRgn(IntPtr handle, IntPtr handleRegion, bool regraw);
        ...
        [System.Runtime.InteropServices.DllImport("User32.dll")]
        private static extern bool SetLayeredWindowAttributes(IntPtr handle, uint colorKey, byte alpha, int flags);
    }
}
